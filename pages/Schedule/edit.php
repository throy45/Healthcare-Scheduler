<?php require_once '../../database.php';
    ...
    if (
        ...
        try {
            $stmt = $conn->prepare("UPDATE Schedule SET EndTime=? WHERE FacilityID=? AND EmployeeID=? AND Date=? AND StartTime=?");
            $stmt->bind_param("siiss", $EndTime, $FacilityID, $EmployeeID, $Date, $StartTime);
            $stmt->execute();
